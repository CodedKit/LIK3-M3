...
interface UserProfileContextType {
  ...
  isLoading: boolean;
  addProfile: (newProfileData: Omit<UserProfile, 'id' | 'showDebug' | 'xp' | 'likes' | 'terminalHistory' | 'money' | 'flags' | 'favoriteSongs' | 'volumeSettings'>) => void;
...
export const UserProfileProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addProfile = useCallback((newProfileData: Omit<UserProfile, 'id' | 'showDebug' | 'xp' | 'likes' | 'terminalHistory' | 'money' | 'flags' | 'favoriteSongs' | 'volumeSettings'>) => {
